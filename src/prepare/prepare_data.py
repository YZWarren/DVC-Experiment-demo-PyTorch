...
parser.add_argument(
    "--dataset", default="shapenet", help="dataset to use [default: shapenet]"
)
parser.add_argument(
    "--category", default="car", help="the class of dataset to use [default: car]"
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=float,
    default=1.0,
    help="Range of Variance Values [default: 1.0]",
)
...
if __name__ == "__main__":
    ...
    data_folder = os.path.join(
        ...
        DATASET,
        CATEGORY,
        "points/" if DATASET == "shapenet" else "",
    )
